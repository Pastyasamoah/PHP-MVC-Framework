...

{
	...
	*/
	...
	
	{
		...
		$this->connect($this->_db_host,$this->_db_username,$this->_db_password,$this->_db_name);
	...
	*/
	...
	private function Connect($db_host, $db_username, $db_password, $db_name)

	{
		$DSN = "mysql:host={$db_host};dbname={$db_name}"; // the driver and database name
